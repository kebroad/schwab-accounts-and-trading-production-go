...
// APIClient manages communication with the Trader API - Account Access and User Preferences API v1.0.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UserPreferenceAPI = (*UserPreferenceAPIService)(&c.common)
