...
// checks if the AccountMutualFund type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountMutualFund{}
...
type _AccountMutualFund AccountMutualFund
...
func (o *AccountMutualFund) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountMutualFund := _AccountMutualFund{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountMutualFund)

	if err != nil {
		return err
	}

	*o = AccountMutualFund(varAccountMutualFund)

	return err
}

type NullableAccountMutualFund struct {
	value *AccountMutualFund
	isSet bool
}

func (v NullableAccountMutualFund) Get() *AccountMutualFund {
	return v.value
}

func (v *NullableAccountMutualFund) Set(val *AccountMutualFund) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAccountMutualFund(val *AccountMutualFund) *NullableAccountMutualFund {
	return &NullableAccountMutualFund{value: val, isSet: true}
}
