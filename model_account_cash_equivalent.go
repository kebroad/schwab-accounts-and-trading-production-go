...
// checks if the AccountCashEquivalent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountCashEquivalent{}
...
type _AccountCashEquivalent AccountCashEquivalent
...
func (o *AccountCashEquivalent) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountCashEquivalent := _AccountCashEquivalent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountCashEquivalent)

	if err != nil {
		return err
	}

	*o = AccountCashEquivalent(varAccountCashEquivalent)
...
func (v NullableAccountCashEquivalent) Get() *AccountCashEquivalent {
	return v.value
}

func (v *NullableAccountCashEquivalent) Set(val *AccountCashEquivalent) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountCashEquivalent) IsSet() bool {
	return v.isSet
}
...
func NewNullableAccountCashEquivalent(val *AccountCashEquivalent) *NullableAccountCashEquivalent {
	return &NullableAccountCashEquivalent{value: val, isSet: true}
}
