...
// checks if the TransactionEquity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionEquity{}
...
type _TransactionEquity TransactionEquity
...
func (o *TransactionEquity) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionEquity := _TransactionEquity{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionEquity)

	if err != nil {
		return err
	}

	*o = TransactionEquity(varTransactionEquity)
...
func (v NullableTransactionEquity) Get() *TransactionEquity {
	return v.value
}

func (v *NullableTransactionEquity) Set(val *TransactionEquity) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTransactionEquity(val *TransactionEquity) *NullableTransactionEquity {
	return &NullableTransactionEquity{value: val, isSet: true}
}
