...
// checks if the TransactionCashEquivalent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCashEquivalent{}
...
type _TransactionCashEquivalent TransactionCashEquivalent
...
func NewTransactionCashEquivalent(assetType string) *TransactionCashEquivalent {
	this := TransactionCashEquivalent{}
...
func (o *TransactionCashEquivalent) UnmarshalJSON(data []byte) (err error) {
	...
	varTransactionCashEquivalent := _TransactionCashEquivalent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransactionCashEquivalent)

	if err != nil {
		return err
	}

	*o = TransactionCashEquivalent(varTransactionCashEquivalent)
...
func (v NullableTransactionCashEquivalent) Get() *TransactionCashEquivalent {
	return v.value
}

func (v *NullableTransactionCashEquivalent) Set(val *TransactionCashEquivalent) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCashEquivalent) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCashEquivalent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCashEquivalent(val *TransactionCashEquivalent) *NullableTransactionCashEquivalent {
	return &NullableTransactionCashEquivalent{value: val, isSet: true}
}
